...
public class DeviceInfoSettingsExts {
    ...
    public void initMTKCustomization(PreferenceGroup parentPreference) {
        ...
        // chusuxia@wind-mobi.com 20160402 -s
		Preference customBuildVersion = findPreference(KEY_CUSTOM_BUILD_VERSION);
		if (customBuildVersion != null) {
			removePreference(customBuildVersion);
		}
        // chusuxia@wind-mobi.com 20160402 -e	
    }
    ...
    private void initBasebandVersion() {
        ...
        /* zhangheting@wind-mobi.com add 20160518 start */	
        String baseband_version =null;
        String baseband_tel = null;
        String[] tokens;
        /* zhangheting@wind-mobi.com add 20160518 end */	
        ...
        if(FeatureOption.WIND_HIDE_BASEBAND_DATE){
            baseband_version =SystemProperties.get("gsm.version.baseband");
            tokens = baseband_version.split(",");
            baseband_tel = tokens[0];
            findPreference(KEY_BASEBAND_VERSION).setSummary(baseband_tel);
        }else{
