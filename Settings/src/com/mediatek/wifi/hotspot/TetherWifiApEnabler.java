...
public class TetherWifiApEnabler extends Fragment
    ...
    //hanweiwei@wind-mobi.com add 2016-06-21 start
    /*when wifi-AP is close, whether wifi's state*/
    private boolean isWifiOn;
    //hanweiwei@wind-mobi.com add 2016-06-21 end
    ...
    private final BroadcastReceiver mReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (WifiManager.WIFI_AP_STATE_CHANGED_ACTION.equals(action)) {
                ...
                enableWifiSwitch();
            }else if (WifiManager.WIFI_STATE_CHANGED_ACTION.equals(action)){//hanweiwei@wind-mobi.com add 2016-06-21 start
                handleWifiStateChanged(intent.getIntExtra(WifiManager.EXTRA_WIFI_STATE, -1));
                //hanweiwei@wind-mobi.com add 2016-06-21 end
            }
        }
    };
    ...
    public void init(Context context) {
        ...
        //hanweiwei@wind-mobi.com mod 2016-06-21 start
        mIntentFilter.addAction(WifiManager.WIFI_STATE_CHANGED_ACTION);
        //hanweiwei@wind-mobi.com mod 2016-06-21 end
    ...
    public void resume() {
        ...
        if (mWifiManager != null){
            isWifiOn = mWifiManager.getWifiState() == WifiManager.WIFI_STATE_ENABLED;
        }
        //hanweiwei@wind-mobi.com add 2016-06-21 end
    ...
    private void handleWifiStateChanged(int state){
        switch (state){
            ...
            case WifiManager.WIFI_STATE_DISABLED:
                    if (mSwitchBar != null && mSwitchBar.isEnabled() ){
                        isWifiOn = false;
                    }
                break;
            default:
