...
// xiangjuncheng@wind-mobi.com 20160413 start
import com.mediatek.settings.FeatureOption;
// xiangjuncheng@wind-mobi.com 20160413 end
...
public class BandwidthUsage extends Fragment {
    ...
    private void refreshTimeAndData() {
        ...
        //caopei@wind-mobi.com add WIND_DEF_PRO_E169F_RUS
        Log.d("xiang","language: "+getResources().getConfiguration().locale.getLanguage());
        if ((FeatureOption.WIND_DEF_OPTR_E181L_RUS || FeatureOption.WIND_DEF_OPTR_E183L_RUS || FeatureOption.WIND_DEF_OPTR_E188F_RUS||FeatureOption.WIND_DEF_PRO_E169F_RUS)
            ...
            if (totalData < mChart.MB_IN_BYTES) {
                ...
                unit = getResources().getString(R.string.wind_wifi_ap_kb_rus);
            } else if (totalData < mChart.GB_IN_BYTES) {
                totalData = totalData / mChart.MB_IN_BYTES;
                unit = getResources().getString(R.string.wind_wifi_ap_mb_rus);
            } else {
                totalData = totalData / mChart.GB_IN_BYTES;
                unit = getResources().getString(R.string.wind_wifi_ap_gb_rus);
            }
        }else {
            if (totalData < mChart.MB_IN_BYTES) {
                totalData = totalData / mChart.KB_IN_BYTES;
