...
/*added by liuxiaoshuan 2016.3.11 for Bug #99646 begin */
import android.os.Handler;
/*added by liuxiaoshuan 2016.3.11 for Bug #99646 end */
...
public class ManageApplications extends InstrumentedFragment
    ...
    Handler mHandler=new Handler(){
        public void handleMessage(android.os.Message msg) {
            if(mFilter == FILTER_APPS_WRITE_SETTINGS || mFilter == FILTER_APPS_WITH_OVERLAY){
                mApplications.mResumed=false;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*modified by liuxiaoshuan 2016.3.11 for Bug #99646 begin */
        if(mFilter==FILTER_APPS_WRITE_SETTINGS || mFilter == FILTER_APPS_WITH_OVERLAY){
            mResetAppsHelper = new ResetAppsHelper(getActivity(),mHandler);}
        else{
            mResetAppsHelper = new ResetAppsHelper(getActivity());
        }
        /*modified by liuxiaoshuan 2016.3.11 for Bug #99646 end */
    }
