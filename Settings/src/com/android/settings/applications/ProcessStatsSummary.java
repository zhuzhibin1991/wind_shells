...
//zhuzhibin@wind-mobi.com add 2016/07/11 start
import com.mediatek.settings.FeatureOption;
//zhuzhibin@wind-mobi.com add 2016/07/11 end
...
public class ProcessStatsSummary extends ProcessStatsBase implements OnPreferenceClickListener {
    ...
    public void refreshUi() {
        ...
        //zhuzhibin@wind-mobi.com modified 2016/07/11 start
        //fix Total memory 1.9G to 2G in Settings Module.
        String totalString = null;
        if(FeatureOption.WIND_DEF_OPTR_E183L_COL){
            long totalRamTemp = (long) totalRam/1000/1000/1000;
            totalString = totalRamTemp + "G";
        // yexumin@wind-mobi.com modified 2016/09/07 begin
        // fix Bug N/A : total memory should be equal to "1G"
        } else if (FeatureOption.WIND_DEF_PRO_E188F || FeatureOption.WIND_DEF_OPTR_E183L_CL || FeatureOption.WIND_DEF_OPTR_E183L_CLA) {
            totalString = "1 GB";
        // yexumin@wind-mobi.com modified 2016/09/07 end
        }else{
            totalString = Formatter.formatShortFileSize(context, (long) totalRam);
        }
        //zhuzhibin@wind-mobi.com modified 2016/07/11 end
