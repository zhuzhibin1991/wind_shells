...
public class SimSelectNotification extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if(context.getPackageManager().resolveActivity(plugOutActivity,0) == null){
        }else{
            //lijingwei@wind-mobi.com Bug #102054 2016/3/21 start
            if(SimPlugOutActivity.instance!=null)
                SimPlugOutActivity.instance.finish();
            //lijingwei@wind-mobi.com Bug #102054 2016/3/21 end
        }
