...
//chusuxia@wind-mobi.com add for #103590 20160401 -s
import com.mediatek.settings.FeatureOption;
import android.os.SystemProperties;
//chusuxia@wind-mobi.com add for #103590 20160401 -e
...
//liuxiaoshuan@wind-mobi.com add 20160614 for Feature#111850 begin
import com.mediatek.settings.FeatureOption;
import android.os.ServiceManager;
import com.android.internal.telephony.PhoneConstants;
import com.mediatek.internal.telephony.ITelephonyEx;
//liuxiaoshuan@wind-mobi.com add 20160614 for Feature#111850 end
/**
...
public class SimStatus extends InstrumentedPreferenceActivity {
        ...
        if (mSelectableSubInfos == null) {
            ...
            if (mSelectableSubInfos.size() > 1) {
                ...
                for (int i = 0; i < mSelectableSubInfos.size(); i++) {
                    //lijingwei@wind-mobi.com Bug #103087 2016/4/21 start
                    if(FeatureOption.WIND_DEF_PRO_E183L||FeatureOption.WIND_DEF_PRO_E188F){
                        mTabHost.setTabLayoutId(com.android.internal.R.layout.tab_indicator_holo_nocaps);
                    }
                    //lijingwei@wind-mobi.com Bug #103087 2016/4/21 end
    ...
    private void updateServiceState(ServiceState serviceState) {
        ...
        //liuxiaoshuan@wind-mobi.com modify 20160614 for Feature#111850 begin
        //fix show plmn if spn not exist
        //lijingwei@wind-mobi.com fix Feature #122197 for spain operator name display 2016.07.26
        if(FeatureOption.WIND_DEF_OPTR_E188F_SP || FeatureOption.WIND_DEF_OPTR_E183L_EUR){
            String operatorAlphaLong=serviceState.getOperatorAlphaLong();
            int mSubId=mSir.getSubscriptionId();
            String operatorNum = getSimOperatorNumeric(mSubId);
            String spn= getSpn(mSubId);
            Log.d(TAG,"getOperatorNumeric()="+serviceState.getOperatorNumeric()+"  getOperatorAlphaLong()="+operatorAlphaLong);
            Log.d(TAG,"mSubId="+mSubId+"  operatorNum="+operatorNum+"  spn="+spn);
        ...
        //liuxiaoshuan@wind-mobi.com modify 20160614 for Feature#111850 end
        /// M: for [C2K SIM Status]
    ...
    private void updatePreference() {
        ...
        if(FeatureOption.WIND_DEF_OPTR_E183L_TEL || FeatureOption.WIND_DEF_OPTR_E183L_CL){
        //yexumin@wind-mobi.com add for #113113 20160530 ens
            rawNumber = mTelephonyManager.getMsisdn(mSir.getSubscriptionId());
        }else{
            rawNumber = mTelephonyManager.getLine1NumberForSubscriber(mSir.getSubscriptionId());
        }
        //chusuxia@wind-mobi.com add for #103590 20160401 -e
        ...
        //add by liuqiong@wind-mobi.com 2016-05-08 begin add SIM Name
        if(FeatureOption.WIND_DEF_OPTR_E183L_TEL){
            formattedNumber = mPhone.getLine1AlphaTag() + " " + formattedNumber;
        }
        //add by liuqiong@wind-mobi.com 2016-05-08 end
        ...
        // chusuxia@wind-mobi.com 20160608 start
        /*modify for modify sv number*/
        //setSummaryText(KEY_IMEI_SV, mphone.getDeviceSvn());
        if (FeatureOption.WIND_CUSTOM_SV_NUMBER){
            setSummaryText(KEY_IMEI_SV,getIMEISVNumber());
        } else {
            setSummaryText(KEY_IMEI_SV, mPhone.getDeviceSvn());
        }
        // chusuxia@wind-mobi.com 20160608 end
    ...
    // chusuxia@wind-mobi.com 20160608 start
    /*add for modify sv number*/
    private String getIMEISVNumber() {
        String IMEISV = SystemProperties.get("ro.build.sv.number","01");
        return IMEISV;
    }
    // chusuxia@wind-mobi.com 20160608 end
    ...
    //liuxiaoshuan@wind-mobi.com add 20160614 for Feature#111850 begin
    private String getSpn(int subId) {
        String spn = null;
        try {
            ITelephonyEx telephony = ITelephonyEx.Stub.asInterface(
                    ServiceManager.getService(Context.TELEPHONY_SERVICE_EX));
            if (telephony != null) {
                spn = telephony.getMvnoPattern(subId,PhoneConstants.MVNO_TYPE_SPN);
            } else {
    ...
    private String getSimOperatorNumeric(int subId) {
        String operatorNum = null;
        TelephonyManager tm = (TelephonyManager) getSystemService(Context.TELEPHONY_SERVICE);
        if(tm!=null)
            operatorNum = tm.getSimOperator(subId);
