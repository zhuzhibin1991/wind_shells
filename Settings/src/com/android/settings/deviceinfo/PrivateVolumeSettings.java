...
import java.util.Objects;
 /*added by liuxiaoshuan@wind-mobi.com 2016.3.28 for bug #101898 begin*/
import android.provider.MediaStore;
 /*added by liuxiaoshuan@wind-mobi.com 2016.3.28 for bug #101898 end*/
/**
...
public class PrivateVolumeSettings extends SettingsPreferenceFragment {
    ...
    private static final int[] ITEMS_SHOW_SHARED = new int[] {
            R.string.storage_detail_apps,
         /*modified by liuxiaoshuan@wind-mobi.com 2016.3.28 for bug #101898 begin*/
            R.string.memory_dcim_usage,
//            R.string.storage_detail_images,
//            R.string.storage_detail_videos,
          /*modified by liuxiaoshuan@wind-mobi.com 2016.3.28 for bug #101898 end*/
    ...
    //modify by liuqiong@wind-mobi.com 2016-04-04 begin
    private long mUsedBytes = 0;
    //modify by liuqiong@wind-mobi.com 2016-04-04 end
...
//                } break;
                ...
                case R.string.storage_detail_other: {
                    ...
                    long allSize = details.appsSize.get(userId) + totalValues(details, userId,
                            Environment.DIRECTORY_DCIM, Environment.DIRECTORY_MOVIES,
                            ...
                            Environment.DIRECTORY_RINGTONES, Environment.DIRECTORY_PODCASTS) +
                            details.cacheSize;
                    if (mUsedBytes > allSize) {
                        updatePreference(item, mUsedBytes - allSize);
                    } else {
                        updatePreference(item, details.miscSize.get(userId));
                    }
                    //modify by liuqiong@wind-mobi.com 2016-04-04 end
