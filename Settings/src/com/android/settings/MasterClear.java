...
//hanweiwei@wind-mobi.com add 20160203 begin feature#96094
...
//hanweiwei@wind-mobi.com add 20160203 end feature#96094
...
public class MasterClear extends InstrumentedFragment {
    ...
    private void establishInitialState() {
	    ...
	    //hanweiwei@wind-mobi.com remove 20160203 begin feature#96094
            //mExternalStorageContainer.setVisibility(View.GONE);
	    //hanweiwei@wind-mobi.com remove 20160203 end feature#96094
	    //hanweiwei@wind-mobi.com add 20160203 begin feature#96094
	    initBackupBtn();
	    updateUI();
	    //hanweiwei@wind-mobi.com add 20160203 end feature#96094
	...
	StorageVolume[] mStorageVolumes =
		mStorageManager.getVolumeList(UserHandle.myUserId(), StorageManager.FLAG_FOR_WRITE);
	if(mStorageVolumes.length>0){
	    for(StorageVolume volumes: mStorageVolumes){
		if(!volumes.isEmulated() &&
		    Environment.MEDIA_MOUNTED.equals(mStorageManager.getVolumeState(volumes.getPath()))){
			return true;
		}
	    }
	}
    ...
    private void initBackupBtn() {
        backupBtn = (Button) mContentView.findViewById(R.id.enter_backup);
        if (FeatureOption.WIND_DEF_OPTR_E188F_IN){
        ...
        backupBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ComponentName comp = new ComponentName("com.mediatek.datatransfer", "com.mediatek.datatransfer.BootActivity");
                intent.setComponent(comp);
                intent.setAction("com.mediatek.backuprestore.intent.MAIN");
