...
//add by liuqiong@wind-mobi.com 2016-03-09 begin
import android.net.Uri;
//add by liuqiong@wind-mobi.com 2016-03-09 end
...
public class SecuritySettings extends SettingsPreferenceFragment
    ...
    //add by liuqiong@wind-mobi.com 2016-03-09 begin
    private static void grantUriPermission(Context context) {
        context.grantUriPermission("com.mediatek.dataprotection", Uri.parse("content://media/external/object?need_update_media_values=true"),
                Intent.FLAG_GRANT_READ_URI_PERMISSION | Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
        context.grantUriPermission("com.mediatek.dataprotection", Uri.parse("content://media/external/file"),
                Intent.FLAG_GRANT_READ_URI_PERMISSION | Intent.FLAG_GRANT_WRITE_URI_PERMISSION);
   }
    //add by liuqiong@wind-mobi.com 2016-03-09 end
