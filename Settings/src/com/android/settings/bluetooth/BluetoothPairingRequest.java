...
import android.os.PowerManager;
    /*added by liuxiaoshuan@wind-mobi.com 2016.4.18 for bug #105049 begin*/
import android.util.Log;
import android.content.ContentResolver;
import android.provider.Settings;
import android.provider.Settings.SettingNotFoundException;
    /*added by liuxiaoshuan@wind-mobi.com 2016.4.18 for bug #105049 end*/
...
public final class BluetoothPairingRequest extends BroadcastReceiver {
    ...
    /*added by liuxiaoshuan@wind-mobi.com 2016.4.18 for bug #105049 begin*/
    private void screenOn(Context mContext,PowerManager pm) {
       if(pm == null){
       ...
       try {
           ...
           wakeUpTime = Settings.System.getInt(contentResolver, Settings.System.SCREEN_OFF_TIMEOUT);
       } catch (SettingNotFoundException e){
           Log.e(TAG, "Exception occured in wakeupScreen()");
       }
       wl.acquire(wakeUpTime);
    }
    /*added by liuxiaoshuan@wind-mobi.com 2016.3.25 for bug #105049 end*/
}
