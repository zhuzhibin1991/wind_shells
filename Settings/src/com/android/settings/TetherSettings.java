...
//liuxiaoshuan@wind-mobi.com 2016.10.20 start
import com.mediatek.settings.FeatureOption;
//liuxiaoshuan@wind-mobi.com 2016.10.20 end
/*
...
public class TetherSettings extends SettingsPreferenceFragment
    ...
    private void updateUsbState(String[] available, String[] tethered,
        ...
        for (String s : tethered) {
            for (String regex : mUsbRegexs) {
                //liuxiaoshuan@wind-mobi.com modify 20161019 add mUsbTether.isChecked()&&!mUsbHwDisconnected  start
                //fix bug 135164
                if(FeatureOption.WIND_DEF_OPTR_E188F_IN){
                    if (s.matches(regex) && mUsbTether.isChecked() && !mUsbHwDisconnected ) usbTethered = true;
                }else{
                    if (s.matches(regex)) usbTethered = true;
                }
                //liuxiaoshuan@wind-mobi.com add 20161019 end
            }
        }
