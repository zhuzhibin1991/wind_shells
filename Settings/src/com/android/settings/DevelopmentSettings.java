...
//hanweiwei@wind-mobi.com add 2016.08.05 start
import com.mediatek.settings.FeatureOption;
//hanweiwei@wind-mobi.com add 2016.08.05 end
...
public class DevelopmentSettings extends SettingsPreferenceFragment
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (FeatureOption.WIND_DEF_PRO_E188F || FeatureOption.WIND_DEF_PRO_E181L){
            mUsbConfiguration.setEntries(R.array.usb_configuration_titles_no_midi);
            mUsbConfiguration.setEntryValues(R.array.usb_configuration_values_no_midi);
        }
        //hanweiwei@wind-mobi.com add 2016.08.05 end
    ...
    private void updateUsbConfigurationValues() {
        if (mUsbConfiguration != null) {
            ...
            if (FeatureOption.WIND_DEF_PRO_E188F){
                values = getResources().getStringArray(R.array.usb_configuration_values_no_midi);
                titles = getResources().getStringArray(R.array.usb_configuration_titles_no_midi);
            }
            //hanweiwei@wind-mobi.com add 2016.08.05 end
            int index = 0;
            for (int i = 0; i < titles.length; i++) {
