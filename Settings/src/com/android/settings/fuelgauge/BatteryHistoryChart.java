...
//bailu@wind-mobi.com 20160615 start
import android.text.TextUtils;
//bailu@wind-mobi.com 20160615 end
...
public class BatteryHistoryChart extends View {
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        if (mLargeMode) {
            /*xiangjuncheng@wind-mobi.com modify 20160226 for bug#98194 start*/
            /*
            mChargingOffset = mLineWidth;
            */
            mChargingOffset = mLineWidth + 7;
            /*xiangjuncheng@wind-mobi.com modify 20160226 for bug#98194 end*/
    ...
    void drawChart(Canvas canvas, int width, int height) {
        ...
        //bailu@wind-mobi.com 20160615 modify for bug #110943 start
        mChargeLabelString = TextUtils.ellipsize(mChargeLabelString, new TextPaint(mHeaderTextPaint), width, TextUtils.TruncateAt.END).toString();
        //bailu@wind-mobi.com 20160615 modify for bug #110943 end
        ...
        if (mLargeMode) {
            ...
            if (mHavePhoneSignal) {
                canvas.drawText(mPhoneSignalLabel, textStartX,
                        height - mPhoneSignalOffset - mTextDescent - 7, mTextPaint);
            }
            if (mHaveGps) {
                canvas.drawText(mGpsOnLabel, textStartX,
                        height - mGpsOnOffset - mTextDescent - 7, mTextPaint);
            }
            if (mHaveFlashlight) {
                canvas.drawText(mFlashlightOnLabel, textStartX,
                        height - mFlashlightOnOffset - mTextDescent - 7, mTextPaint);
            }
            if (mHaveCamera) {
                canvas.drawText(mCameraOnLabel, textStartX,
                        height - mCameraOnOffset - mTextDescent - 7, mTextPaint);
            }
            if (mHaveWifi) {
                canvas.drawText(mWifiRunningLabel, textStartX,
                        height - mWifiRunningOffset - mTextDescent - 7, mTextPaint);
            }
            canvas.drawText(mCpuRunningLabel, textStartX,
                    height - mCpuRunningOffset - mTextDescent - 7, mTextPaint);
            canvas.drawText(mChargingLabel, textStartX,
                    height - mChargingOffset - mTextDescent - 7, mTextPaint);
            canvas.drawText(mScreenOnLabel, textStartX,
                    height - mScreenOnOffset - mTextDescent - 7, mTextPaint);
            /*xiangjuncheng@wind-mobi.com modify 20160226 for bug#98194 end*/
