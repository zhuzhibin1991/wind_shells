...
public class PowerUsageSummary extends PowerUsageBase {
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (!(preference instanceof PowerGaugePreference)) {
            /// M: power usage extends features {@
        //A: WOS windpowersaver V2.0 zhangheting@wind-mobi.com 20160303 begin 
        ...
        //A: WOS windpowersaver V2.0 zhangheting@wind-mobi.com 20160303 end
            /// @}
            return false;
        }
    ...
    protected void refreshStats() {
        ...
        //A: WOS windpowersaver V2.0 zhangheting@wind-mobi.com 20160419 begin 
//        if(!android.os.SystemProperties.get("ro.wind_os_app_windpowersaver").equals("1")){
//        	mPowerUsageExts.initPowerUsageExtItems();
//        }
        //A: WOS windpowersaver V2.0 zhangheting@wind-mobi.com 20160419 end
