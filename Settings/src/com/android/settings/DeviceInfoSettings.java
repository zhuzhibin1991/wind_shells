...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    /* shengbotao@wind-mobi.com 20150120 for #96089 end */
    //chusuxia@wind-mobi.com  20160401 add hadware version details start
    private static final String KEY_HARDWARE_VERSION = "hardware_version";
    //chusuxia@wind-mobi.com  20160401 add hadware version details end	
    ...
    public void onCreate(Bundle icicle) {
        ...
        //liuxiaoshuan@wind-mobi.com add FeatureOption.WIND_DEF_OPTR_E188F_MAL for feature 129546
        if(FeatureOption.WIND_DEF_OPTR_E183L_MAL || FeatureOption.WIND_DEF_OPTR_E188F_MAL) {
            addPreferencesFromResource(R.xml.device_info_settings_e183l_mal);
        } else {
        ...
        /* zhangheting@wind-mobi.com modify 20160518 start */	
        String baseband = SystemProperties.get("gsm.version.baseband");
        String baseband_tel = null;
        String[] tokens;
        tokens = baseband.split(",");
        baseband_tel = tokens[0];
        ...
        //if(FeatureOption.WIND_DEF_OPTR_E183L_TEL || FeatureOption.WIND_DEF_OPTR_E183L_PE){
        if(FeatureOption.WIND_HIDE_BASEBAND_DATE){
            setStringSummary(KEY_BASEBAND_VERSION, baseband_tel);
        }else{
            setValueSummary(KEY_BASEBAND_VERSION, "gsm.version.baseband");
        }
        //xiangjuncheng@wind-mobi.com 2016.07.01 end
        //bailu@wind-mobi.com 20160711 end
        /* zhangheting@wind-mobi.com modify 20160518 end */
        setStringSummary(KEY_DEVICE_MODEL, Build.MODEL + getMsvSuffix());
        setValueSummary(KEY_EQUIPMENT_ID, PROPERTY_EQUIPMENT_ID);
        setStringSummary(KEY_DEVICE_MODEL, Build.MODEL);
        setStringSummary(KEY_BUILD_NUMBER, Build.DISPLAY);
        findPreference(KEY_BUILD_NUMBER).setEnabled(true);
        //liuxiaoshuan@wind-mobi.com 2016/07/27 start
        //fix delete all zte string in kernel version
        if(FeatureOption.WIND_DEF_OPTR_E188F_MX){
            String customKernelVersion = getFormattedKernelVersion();
            if(customKernelVersion.contains("+")){
                customKernelVersion = customKernelVersion.replace(customKernelVersion.substring(customKernelVersion.indexOf("+")), "");
            }
            findPreference(KEY_KERNEL_VERSION).setSummary(customKernelVersion);
        }else{
            findPreference(KEY_KERNEL_VERSION).setSummary(getFormattedKernelVersion());
        }
        //liuxiaoshuan@wind-mobi.com 2016/07/27 end
        /* shengbotao@wind-mobi.com 20150120 for #96089 start */
        findPreference(KEY_PHONE_NAME).setSummary(SystemProperties.get("persist.sys.settings.phonename"));
        findPreference(KEY_PHONE_NAME).setEnabled(true);
        /* shengbotao@wind-mobi.com 20150120 for #96089 end */

        //fengsong@wind-mobi.com add for feature 111858 start
        if(FeatureOption.WIND_DEF_OPTR_E183L_MAL) {
            setStringSummary(KEY_DEVICE_MODEL, "ZTE T630");
        }
        //fengsong@wind-mobi.com add for feature 111858 end

        // xiongjuan@wind-mobi.com 2016/07/21 start
        if(FeatureOption.WIND_DEF_OPTR_E169F_RUS) {
            setStringSummary(KEY_DEVICE_MODEL, "ZTE BLADE X3");
            findPreference(KEY_PHONE_NAME).setSummary("ZTE BLADE X3");
        }
        // xiongjuan@wind-mobi.com 2016/07/21 end
        ...
        /* shengbotao@wind-mobi.com 20150120 for #96089 start */
        /* xushuaho@wind-mobi.com 20160506  start */
        if(!FeatureOption.WIND_PHONE_NAME_SUPPORT||FeatureOption.WIND_DEF_OPTR_E183L_TEL){
            getPreferenceScreen().removePreference(findPreference(KEY_PHONE_NAME));
        }
        /* xushuhao@wind-mobi.com 20160506  end */
        /* shengbotao@wind-mobi.com 20150120 for #96089 end */
		
		//chusuxia@wind-mobi.com  20150405 add hadware version details start
        setStringSummary(KEY_HARDWARE_VERSION, SystemProperties.get("ro.product.hardware", "MBV1.0"));
        //chusuxia@wind-mobi.com  20150405 add hadware version details end
	 ...
	 /*chusuxia@wind-mobi.com 20160215 add start */
        if(FeatureOption.WIND_DEF_SUPPORT_ZTE_FOTA){
		Preference preference = findPreference("ztefota_software_update");
		if (preference != null) {
		preference.setTitle(getAppName(act, "com.zte.zdm"));
		}
        }
	 /*chusuxia@wind-mobi.com 20160215 add end */
    }
    ...
    public void onResume() {
        ...
        filter.addAction(PhoneNameConfig.PNAME_CHANGED_ACTION);
    ...
    private BroadcastReceiver mBroadcast = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(action != null && action.equals(PhoneNameConfig.PNAME_CHANGED_ACTION)){
                setStringSummary(KEY_PHONE_NAME,new PhoneNameConfig().getPhoneName());
            }
        }
    };
    /*shengbotao@wind-mobi.com 20150120 for #96089 end*/
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        /* shengbotao@wind-mobi.com 20150120 for #96089 start */
        } else if(preference.getKey().equals(KEY_PHONE_NAME)){
            new PhoneNameDialogFragment(preference).show(
    ...
    public static String formatKernelVersion(String rawKernelVersion) {
        ...
        // zhangheting@wind-mobi.com add 20160518 -s
        //xiangjuncheng@wind-mobi.com 2016.07.01 start
        //fix file entel Buglist of A610_feedback_0629 No.10
        if (FeatureOption.WIND_DEF_OPTR_E183L_TEL) {
            return m.group(1);
        }else if (FeatureOption.WIND_DEF_OPTR_E183L_PE){
            return m.group(1) + "\n" + m.group(2) + " " + m.group(3);
        }else{
            return m.group(1) + "\n" +                 // 3.0.31-g6fb96c9
                m.group(2) + " " + m.group(3) + "\n" + // x@y.com #1
        ...
        //xiangjuncheng@wind-mobi.com 2016.07.01 end
        // zhangheting@wind-mobi.com add 20160518 -e
    }
...
/*chusuxia@wind-mobi.com 20160220 add start */
...
/*chusuxia@wind-mobi.com 20160220 add end */
