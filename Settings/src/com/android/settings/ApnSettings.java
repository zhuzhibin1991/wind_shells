...
public class ApnSettings extends SettingsPreferenceFragment implements
        ...
        */
        ...
        if (cursor != null) {
            ...
            while (!cursor.isAfterLast()) {
                ...
                //yexumin add for feature 113020 20160531 start
                if (FeatureOption.WIND_DEF_OPTR_E183L_CL && "73001".equals(mccmnc)) {
                    Log.d(TAG, "73001 setApnEditable false");
                    pref.setApnEditable(false);
                }
                //yexumin for feature 113020 20160531 end
                //huangyaling@wind-mobi.com modify 2016.07.07 begin
                // liuyangyao@wind-mobi.com for 117110 20160628 begin
                if (FeatureOption.WIND_DEF_OPTR_E183L_CLA || FeatureOption.WIND_DEF_OPTR_E183L_PE) {
                    pref.setApnEditable(sourcetype == 1);
                }
                // liuyangyao@wind-mobi.com for 117110 20160628 end
                //huangyaling@wind-mobi.com modify 2016.07.07 end
    ...
    private boolean restoreDefaultApn() {
        ...
        if (FeatureOption.WIND_DEF_OPTR_E183L_EUR) {
            SystemProperties.set("persist.sys.newapnid", "0");
        }
        //lijingwei@wind-mobi.com 2016.07.26 end
        return true;
    }
