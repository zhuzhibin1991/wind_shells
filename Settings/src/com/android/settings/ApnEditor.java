...
public class ApnEditor extends InstrumentedPreferenceActivity
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        ...
        if (KEY_AUTH_TYPE.equals(key)) {
            ...
            //lijingwei@wind-mobi.com ID:5752 2016/5/9 start
            mProtocol.setValue((String) newValue);
            mProtocol.setSummary(protocol);
            //lijingwei@wind-mobi.com ID:5752 2016/5/9 end
    ...
    private void deleteApn() {
        ...
        if (FeatureOption.WIND_DEF_OPTR_E183L_EUR) {
            String id = "";
            if (mCursor != null){
                id = mCursor.getString(ID_INDEX);
            }
            String newApnId = SystemProperties.get("persist.sys.newapnid");
            Log.v(TAG, "deleteApn: id=" + id + " newApnId=" + newApnId);
            if (id.equals(newApnId)){
