...
import com.android.settings.PhoneNameConfig;
...
//                                }
//                            }
                        //huangyaling@wind-mobi.com modfiy for bug#99618 end
                        }
                        mWifiP2pManager.setDeviceName(mChannel,
                            ...
                            public void onSuccess() {
                                ...
                                if(FeatureOption.WIND_PHONE_NAME_SUPPORT) {
                                    doNotPhoneName(mDeviceNameText.getText().toString());
                                }
								/*shengbotao@wind-mobi.com 20150120 for #96089 end*/
                            }
...
/*shengbotao@wind-mobi.com 20150120 for #96089 start*/
    private void doNotPhoneName(String newName) {
        PhoneNameConfig pc = new PhoneNameConfig();
        if(!pc.getChanged(PhoneNameConfig.WIFI_NAME)){
            String deviceName = pc.getPhoneName();
            if(deviceName != null && !deviceName.equals(newName)){
                Log.v(TAG,"doNot setChanged");
                pc.setChanged(PhoneNameConfig.WIFI_NAME,true);
            }
        }
    }
	/*shengbotao@wind-mobi.com 20150120 for #96089 end*/
